...
class BaseReport(models.Model):
    ...
    occurring_number = models.CharField('Número do Boletim', max_length=200, default='', null=True)
    designated_date = models.CharField('Data de Designação', max_length=200, blank=True, null=True)
    exam_objective = models.CharField('Objetivo do Exame', max_length=300, default='')
    occurrence_nature = models.CharField('Natureza da Ocorrência', max_length=300, default='', null=True)
    ...
    service_date = models.CharField('Data do Atendimento', max_length=20, blank=True, null=True)
    service_time = models.TimeField('Hora do Atendimento', auto_now=False, blank=True, null=True)
    director = models.CharField('Diretor', max_length=200, default='')
    nucleus = models.CharField('Núcleo', max_length=200, default='')
    team = models.CharField('Equipe de Perícias', max_length=200, default='')
    reporting_expert = models.CharField('Perito Relator', max_length=200, default='')
    assistant_expert = models.CharField('Perito Assistente', max_length=200, blank=True, null=True, default='')
    photographer = models.CharField('Fotógrafo', max_length=200, blank=True, null=True, default='')
    draftsman = models.CharField('Desenhista', max_length=200, blank=True, null=True, default='')
